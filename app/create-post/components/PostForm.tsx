...
const PostForm: React.FC<PostFormProps> = ({ userAvatar, onSubmit }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between pt-4 border-t border-gray-100 space-y-4 sm:space-y-0 text-center sm:text-left">
        <label className={`w-full sm:w-auto justify-center cursor-pointer px-4 py-2 text-purple-600 hover:bg-purple-50 rounded-lg transition-colors flex items-center space-x-2 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}>
        ...
        <button
          ...
          className={`w-full sm:w-auto px-8 py-2.5 rounded-full font-semibold transition-all ${
